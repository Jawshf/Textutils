        ...
        <div className="container" style={myStyle}>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" data-parent="#accordionExample">
                ...
                <div className="accordion-item" style={myStyle}>
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" data-parent="#accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" data-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
